...
export default function RegisterPage() {
  return (
    <main className="flex min-h-dvh w-full items-center justify-center bg-gradient-to-br from-[var(--color-bg)] via-azure-50 to-azure-100 px-4 py-8 sm:px-6 md:py-12">
      <section className="flex w-full max-w-6xl flex-col items-stretch justify-center gap-10 lg:flex-row lg:items-center lg:justify-between lg:gap-16">
        <AuthHeroTitle />
        <AuthFormBody initialMode="register" />
      </section>
    </main>
  );
}
